...
<div class="offcanvas offcanvas-end w-50" tabindex="-1" id="tasksDetailsOffcanvas" xmlns="http://www.w3.org/1999/html">
    ...
    <div class="offcanvas-body">
        <form action="{{ route('planned-works.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="form-group mb-4">
                    ...
                    <textarea name="required_expenses" rows="10" id="editor2" class="form-control"></textarea>
                </div>
                <div class="form-group mb-4">
                    <label class="form-label">Таёрлаш муддати:</label>
                    <textarea name="preparation_time" rows="10" id="editor3" class="form-control"></textarea>
                </div>
                <div class="form-group mb-4">
                    <label class="form-label"> Кўрсаткич натижалар:</label>
                    <textarea name="performance_results" rows="10" id="editor4" class="form-control"></textarea>
                </div>
                <div class="form-group mb-4">
                    <label class="form-label">Талаб қилаётган миқдори:</label>
                    <textarea name="required_amount" rows="10" id="editor5" class="form-control"></textarea>
                </div>
