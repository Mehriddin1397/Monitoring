...
{{--                            <img src="{{ asset('storage/'.$photo->file_path) }}" id="userImage" alt="User Photo">--}}

{{--                        @endforeach--}}
{{--                    </div>--}}
                    <p>Rasmni o`zgartirish uchun rasm yuklang!</p>
{{--                    <form action="{{ route('users.update',$user->id) }}" method="POST" enctype="multipart/form-data">--}}
{{--                        @csrf--}}
{{--                        @method('PATCH')--}}
{{--                        <input type="file" name="photo" class="user-profile-upload" id="uploadImage" accept="image/*">--}}
{{--                        <div class="user-profile-info">--}}
{{--                            <h2 class="user-profile-name">Foydalanuvchi Ismi: {{$user->name}}--}}
{{--                            </h2>--}}
{{--                            <input type="text" name="name" value="{{$user->name}}">--}}
{{--                            <p class="user-profile-email">Email: {{$user->email}}</p>--}}
{{--                            <input type="email" name="email" value="{{$user->email}}">--}}
{{--                            <p class="user-profile-role">Telefon raqami: @if($user->telephone)--}}
{{--                                    {{$user->telephone}}--}}
{{--                                @else--}}
{{--                                    Telefon raqam yo`q--}}
{{--                                @endif--}}
...
{{--                            <p class="user-profile-date">Roli: {{$user->role}}</p>--}}
{{--                            @if($user->role == 'admin')--}}
