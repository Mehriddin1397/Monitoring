...
@section('content')
                                        ...
                                        <tr class="single-item">
                                            ...
                                            <td>
                                                <div class="hstack gap-2 justify-content-end">
                                                    ...
                                                    @endif
                                                    @if(auth()->user()->role == 'admin')
                                                        <form action="{{route('completed-works.destroy', $work->id)}}  "
                                                              method="POST">
                                                            @csrf
                                                            @method('DELETE')
    ...
    @include('components.admin.lab_bajarilgan.project-modal-create')
    @include('components.admin.lab_bajarilgan.project-modal-edit', ['works' => $works])
