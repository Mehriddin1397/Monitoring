...
@section('title', 'Жараёндаги ишлар')
...
@section('content')
        ...
        <div class="page-header " style="background-color: #7878a3">
            <div class="page-header-left d-flex align-items-center">
                <div class="page-header-title">
                    <h5 class="m-b-10  text-white" >Жараёндаги ишлар</h5>
                </div>
            </div>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive table-container table-wrapper" style=" overflow-y: auto;">
                                ...
                                <table class="table table-hover " id="proposalList">
                                    ...
                                    <tbody style=" background-color: {{$work->process_color}} ">
                                        <tr class="single-item">
                                            ...
                                            <td>
                                                <div class="hstack gap-2 justify-content-end">
                                                    ...
                                                    @endif
                                                    @if(auth()->user()->role == 'admin')
                                                        <form action="{{route('ongoing-works.destroy', $work->id)}}  "
                                                              method="POST">
                                                            @csrf
                                                            @method('DELETE')
    ...
    @include('components.admin.lab_jarayonda.project-modal-create')
    @include('components.admin.lab_jarayonda.project-modal-edit', ['works' => $works])
